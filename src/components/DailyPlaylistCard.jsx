...
const DailyPlaylistCard = () => {
  return (
    <div className="flex flex-col rounded-lg min-h-64 gap-2 w-52 px-3 py-3 shadow-2 hover:bg-purple-100 transition-colors duration-150 cursor-pointer items-center">
